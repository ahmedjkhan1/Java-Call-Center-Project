...
// Supervisor Class - Extends the Employee class and uses employee constructor to set values of the employee class
public class Supervisor extends Employee{
	Supervisor(String name, CallDispatcher callDispatcher) {
